...
view model =
    div [ class "container" ]
        ...
        , div [ class "godfather" ]
            [ p [ class "footer" ] [ text "Made with love at", a [ href "http://luma.studio" ] [ text "luma.studio" ] ]
            , img [ src "http://files.vividscreen.info/soft/b64f2c51a245c9e7dc6ba2d65860642f/The-Godfather-Don-Vito-square-l.jpg" ] []
            ]
        ]
